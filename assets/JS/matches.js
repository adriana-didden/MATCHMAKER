...
function getMatches () {
    ...
    var headingAndDiv = $("<div id='display-div' class='container has-text-centered'><h2 class='title has-text-centered sriracha'>Your Adoption Matches</h2><div id='answer-columns' class='columns is-multiline'></div><button id='clearMatchHistory' class='button has-text-centered is-danger mali'>Clear Match History</button><br><div class='fb-share-button' data-href='https://adriana-didden.github.io/Project1/' data-layout='button' data-size='small'><a target='_blank' href='https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fadriana-didden.github.io%2FProject1%2F&amp;src=sdkpreparse' class='fb-xfbml-parse-ignore'>Share</a></div><br><a href='https://twitter.com/share?ref_src=twsrc%5Etfw&text=https://adriana-didden.github.io/Project1/' class='twitter-share-button' data-show-count='false'>Tweet</a></div>");
